...
export const metadata: Metadata = {
  title: "About",
  description:
    "Designer turned product developer in the Philippines. Five years of brand work, now building full products with AI tools. Also: Hyrox, horses, and three brown dogs.",
};
        ...
        <Reveal>
          <div className="lg:sticky lg:top-24">
            ...
            <p className="mt-4 font-mono text-[11px] tracking-[0.16em] text-muted uppercase">
              Deb · Product developer & designer · PH GMT+8
            </p>
          </div>
        </Reveal>
